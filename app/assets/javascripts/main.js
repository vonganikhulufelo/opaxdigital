$(document).ready(function(){
	...
	$('#addrow').click(function(){
		$('.item-row:last').after('<tr class="item-row"><td class="zone_id"></td><td class="product_id"></td><td class="price"><span class="price"></span></td><td class="net"><span class="price"></td><td class="order_qty"><span class="price"></td><td class="order_value"><span class="price"></td><td class="delete_td"><a class="delete" href="javascript:;" title="Remove row"><span class="ti-close"></span></a></td></tr>');
