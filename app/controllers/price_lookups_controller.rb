class PriceLookupsController < ApplicationController
    ...
    .group('magisterial_districts.zonedistrict, magisterial_districts.magisterialdistrict_code, magisterial_districts.magisterialdistrict_province, product_prices.productprice_price, product_prices.productdescription_product,product_prices.uid,product_prices.updated_at').paginate(page: params[:page], per_page: 30).order('zonedistrict ASC')
    end
